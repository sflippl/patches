...
__all__ = ['Contrastive1DTimeSeries', 'Contrastive2DTimeSeries']
...
class Contrastive2DTimeSeries(data.Dataset):
    """Creates a contrastive sample of a two-dimensional time series.
    """
